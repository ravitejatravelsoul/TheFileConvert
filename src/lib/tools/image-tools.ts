...
export const imageTools: ToolDefinition[] = [
  {
    ...
    href: "/image/compress",
    name: "Compress Image",
    description: "Pick a target size — under 100 KB, 250 KB, 500 KB, 1 MB, or custom — and it automatically finds the best quality that fits.",
    category: "image",
    acceptedExtensions: IMAGE_EXT,
    acceptedMimeTypes: IMAGE_MIME,
    outputExtensions: ["jpg", "webp"],
    processingMode: "local",
    status: "available",
    supportsMultiple: true,
    maxRecommendedSizeMb: 60,
    keywords: ["compress image", "reduce image size", "image compressor", "image under 1mb", "photo under 500kb"],
    workflow: "file",
